...
class VariantSelects extends HTMLElement {
  ...
  renderProductInfo() {
    fetch(`${this.dataset.url}?variant=${this.currentVariant.id}&section_id=${this.dataset.originalSection ? this.dataset.originalSection : this.dataset.section}`)
      ...
      .then((responseText) => {
        ...
        const skuvariant = html.getElementById(`sku-variant-product`);
        $("#sku-variant-product").html(skuvariant);
  ...
  toggleAddButton(disable = true, text, modifyClass = true) {
    ...
    const containerinfo = document.getElementById('ProductInfoContainer');
    ...
    if (disable) {
      ...
      containerinfo.setAttribute('disabled', 'disabled');
      if (text) addButtonText.textContent = text;
    } else {
      addButton.removeAttribute('disabled');
      containerinfo.removeAttribute('disabled');
