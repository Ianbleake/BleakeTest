...
renderProductInfo() {
  ...
  fetch(
    ...
    .then((responseText) => {
      ...
      const custominfoDestination = document.getElementById(`info-${this.dataset.section}`);
      const custominfoSourse = html.getElementById(`info-${this.dataset.originalSection ? this.dataset.originalSection : this.dataset.section}`);
      ...
      if (custominfoSourse && custominfoDestination) {
        ...
        if(this.currentVariant.title.includes('Personalizada')){
          ...
          custominfoDestination.classList.add('hidden');
        }
      }
